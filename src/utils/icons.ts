/**
 * Inline SVG icons (24x24 viewBox). Use with class "icon" for sizing.
 */
const svg = (path: string, stroke = 'currentColor') =>
...
export const icons = {
	...
	refresh: svg('<polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0114.13-3.36L23 10M1 14l5.36 4.36A9 9 0 0020.49 15"/>'),
	...
	checkLarge: svg('<path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>', 'white'),
} as const;
